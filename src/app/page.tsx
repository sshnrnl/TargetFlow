  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res?.error) {
      ...
      toast("Welcome Back User!", {
        position: "top-right",
        description:
          "Setting up the environment for you! Please wait for awhile...",
        action: {
          label: "Close",
          onClick: () => console.log("Undo"),
        },
        ...
        <div className="lg:flex hidden h-full w-full bg-foreground p-10  flex-col justify-between">
          <div className="flex items-center gap-2">
            <img
              ...
              alt=""
            />
            <h1 className="text-background text-lg leading-none font-medium">
              PT Mitra Karya Sejahtera
            </h1>
          </div>
          <div className="flex flex-col gap-2">
            <p className="text-lg text-background">
              “This app is created to help streamline your workflow, save time,
              and deliver stunning services to your clients with ease and
              efficiency.”
            </p>
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 lg:px-0 px-6 sm:w-[350px] ">
          <div className="flex-col flex justify-center">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Use an existing account to proceed.{" "}
            </p>
          </div>
          <form
          ...
          >
            ...
            >
              <span className="group inline-flex items-center">Sign In</span>
